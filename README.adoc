...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/leo-demetrio/sistema-bancario-java-junit/maven[GitHub Workflow Status]
